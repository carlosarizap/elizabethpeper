...
> = {
  ...
  shipped: STANDARD_ORDER_ITEM_STATUSES.SHIPPED,
  cd_in_progress: STANDARD_ORDER_ITEM_STATUSES.SHIPPED,
  delivery_in_progress: STANDARD_ORDER_ITEM_STATUSES.SHIPPED,
  delivery_with_problems: STANDARD_ORDER_ITEM_STATUSES.SHIPPED,
  available_at_pickup: STANDARD_ORDER_ITEM_STATUSES.SHIPPED,
  available_at_store: STANDARD_ORDER_ITEM_STATUSES.SHIPPED,
  client_changed_address: STANDARD_ORDER_ITEM_STATUSES.SHIPPED,
  delivered: STANDARD_ORDER_ITEM_STATUSES.DELIVERED,
